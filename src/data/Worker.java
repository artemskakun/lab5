...
public class Worker implements Comparable<Worker> {
    ...
    public Worker(int id, String name, Coordinates coordinates, Date creationDate, double salary, Position position, Status status, Organization organization) {
        this.id = id;
        this.name = name;
    ...
    public int compareTo(Worker worker) {
        ...
        else if(salary == worker.getSalary()){
            return 0;
        }
        else return 1;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Worker) {
            ...
            return name.equals(worker.getName()) && coordinates.equals(worker.getCoordinates()) &&
                    (salary == worker.getSalary()) && (position == worker.getPosition()) &&
                    (status == worker.getStatus()) && organization.equals(worker.getOrganization());
        }
        return false;
    }
}